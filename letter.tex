\documentclass[american,svgnames,x11names,version=last,fromphone,fromemail]{scrlttr2}
...
\usepackage{rebuttal}
\usepackage{lipsum}
% TODO varioref conflicts with cleveref
%\usepackage{varioref}
\usepackage{hyperref}
\usepackage{cleveref}
...
\begin{rebuttal}[Specific Comments]
  ...
  \begin{answer}
    ...
    figures more independent of the text.
  \end{answer}
...
fooo dasdasdasdas asdad \addition[label=a:foo,ref=c:specific]{foo bar}.
\lipsum[1]

fooo dasdasdasdas asdad \deletion[label=a:foo1,ref=c:c2]{and one more addition}
